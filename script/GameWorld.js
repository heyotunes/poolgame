...
/**This code is responsible for managing the pool table, the balls, and how they interact during the game. It sets up the initial positions for all the balls, including red, yellow, black, and the white cue ball. It checks when the balls are hit and how they collide with each other, adjusting their movement and speed after every collision. If the white ball is hit into a pocket or moved incorrectly, the game lets the player reposition it. The code also detects when the balls are moving or stationary, updating the game accordingly. Finally, it draws the balls and stick on the screen and resets the game after each round. */
