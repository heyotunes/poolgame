...
/**This code controls the rules and turns in a pool game, tracking scores and handling player actions. It starts by setting up the game rules and defining positions for the balls, players, and the table's edges and pockets. Each player gets a score tracker for the current game and their overall score. During the game, it checks if a player's move follows the rules, like whether they hit the correct ball or committed a foul. When a ball goes into a hole, the game decides whether the player scores, switches turns, or wins. It also resets everything when a new game starts or when rules are broken. */
