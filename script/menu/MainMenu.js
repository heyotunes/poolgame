...
function generateMainMenuButtons(inGame) {
  ...
  const manageFriendsButton = new Button(
    sprites.friendButton, // Use the newly loaded sprite
    new Vector2(200, dev + 600),
    function () {
      window.location.href = "./script/friends.html"; // Navigate to friends management page
    },
    sprites.friendButton // Use the hover sprite when the button is hovered
  );
...
/*This code creates the main menu for the pool game, where players can choose different options and settings. It defines two functions: one for creating the labels (text) and another for the buttons that the player can press. For example, the "Continue" button lets you keep playing if you’re in the middle of a game, and the "Mute" button turns the sound on or off. There are also buttons for choosing between "Player vs Player" and "Player vs Computer," as well as options for selecting different difficulty levels when playing against the computer. When you press a button, the game responds by starting a new game or changing settings like the sound. This makes the main menu interactive and allows players to customize their experience before starting the game.*/
